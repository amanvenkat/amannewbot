            ...
            if (content.includes('heads')) {
                ...
                if (coinFlip === heads) {
                    await util.updateDBUser(message.author.id, {
                        pocket: randomNum(1, 1000)
                    });
                    return message.channel.send('It was heads! You have been awarded some coin!').catch(() => {});
                } else {
                ...
                if (coinFlip === tails) {
                    ...
                    return message.channel.send('It was tails! You have been awarded some coin!').catch(() => {});
                } else {
